...
"""
  Return world coordinates of the pick object and the place object using the following steps:
  1) 
  2)
  3) 
  4) 
...
rospy.init_node('get_pick_place_world_coordinates')


def depth_callback(msg):

  """
  Return coordinates of the pick object and the place object in the world coordinates:
  1) 
  2)
  3) 
  4) 
...
depth_points = rospy.Subscriber("/camera_rgbd/depth/points", PointCloud2, depth_callback, queue_size=1)
